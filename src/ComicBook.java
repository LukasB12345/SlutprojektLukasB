...
public class ComicBook extends Book { //This is a SUB-class, a ComicBook is a sort of book. (inherits).Contains the information that every comicbook that is created needs.
    //Attributes:
